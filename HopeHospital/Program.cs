...
namespace HopeHospital
{
    class Program
    {
        ...
        {
            //Creating lists for each class - this just creates a list of the names or whatever, not a database - not really helpful 
            ...
            //List<doctor> doctorName = new List<doctor>(); creates list of OBJECTS
            //foreach (doctorName in doctors)
